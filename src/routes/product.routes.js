...
const { checkProductLimit } = require('../middlewares/plan-limiter.middleware');
 ...
 * @access Admin/Super Admin
 */
router.post('/bulk', restrictTo('ADMIN', 'SUPER_ADMIN'), checkProductLimit, ProductController.bulkCreate);
 ...
 * @access Admin/Super Admin
 */
router.post('/', restrictTo('ADMIN', 'SUPER_ADMIN'), checkProductLimit, ProductController.create);
